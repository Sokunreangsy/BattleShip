...
namespace MyGame
{
    public static class GameResources
    {
        ...
        public static void LoadResources()
        {
            ...
            LoadFonts();
            SwinGame.Delay(Conversions.ToUInteger(100));
        ...
        private static void ShowLoadingScreen()
        {
            ...
            SwinGame.DrawBitmap(_Background, (float)0, (float)0);
        ...
        private static void PlaySwinGameIntro()
        {
            ...
            SwinGame.Delay(Conversions.ToUInteger(200));

            int i;
            for (i = 0; i <= ANI_CELL_COUNT - 1; i++)
            {
                SwinGame.DrawBitmap(_Background, (float)0, (float)0);
                SwinGame.Delay(Conversions.ToUInteger(20));
                SwinGame.RefreshScreen();
                SwinGame.ProcessEvents();
            }

            SwinGame.Delay(Conversions.ToUInteger(1500));
        }
        ...
        private static void ShowMessage(string message, int number)
        {
            ...
            SwinGame.DrawBitmap(_LoaderEmpty, (float)BG_X, (float)BG_Y);
            SwinGame.DrawCell(_LoaderFull, 0, (float)BG_X, (float)BG_Y);
        ...
        {
            SwinGame.ProcessEvents();
            SwinGame.Delay(Conversions.ToUInteger(500));
