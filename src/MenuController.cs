...
/// </summary>
    static class MenuController
    {
        ...
        private readonly static Color MENU_COLOR = SwinGame.RGBAColor(Conversions.ToByte(2), Conversions.ToByte(167), Conversions.ToByte(252), Conversions.ToByte(255));
        private readonly static Color HIGHLIGHT_COLOR = SwinGame.RGBAColor(Conversions.ToByte(1), Conversions.ToByte(57), Conversions.ToByte(86), Conversions.ToByte(255));
